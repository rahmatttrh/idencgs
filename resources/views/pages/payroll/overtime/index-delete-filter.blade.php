...
<div class="page-inner">
   ...
   <div class="card shadow-none border ">
      <div class=" card-header">
         SPKL Delete Multiple [{{formatDate($from)}} - {{formatDate($to)}}]
         <a href="{{route('payroll.overtime.index.delete')}}">Filter ulang...</a>
      </div>
      ...
      <form action="{{route('payroll.overtime.multiple.delete')}}" method="post" >
         ...
         <div class="card-body px-0">
            ...
            <div class="d-inline-flex align-items-center">
               <button type="submit" name="submit" class="btn btn-sm btn-danger mx-3">Delete</button>
               <div class="d-inline-flex align-items-center">
