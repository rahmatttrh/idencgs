...
<div class="page-inner">
   ...
   <div class="row">
      ...
      <div class="col-md-3">
         ...
         <button type="submit" name="submit" class="btn btn-sm btn-block btn-danger mr-3">Delete <span class="ml-2 badge badge-muted badge-counter">
            <span id="total">0</span>
         </span></button>
         <hr>
         <b>#INFO</b> <br>
         <small>Klik 'Check Box' di list SPKL yang ingin dihapus</small> <br>
         <small>Klik 'Delete' untuk menghapus data</small>
         <hr>
