      ...
      <div class="col-md-4">
         ...
         <div class="card card-light shadow-sm">
            ...
            <div class="nav flex-column justify-content-start nav-pills nav-primary" id="v-pills-tab" role="tablist" aria-orientation="vertical">
               @if (auth()->user()->hasRole('Administrator|HRD|HRD-Recruitment|HRD-Kpi|HRD-Admin|HRD-Spv|HRD-Payroll|HRD-KJ12|HRD-KJ45|HRD-JGC') || auth()->user()->username == $employee->nik )
