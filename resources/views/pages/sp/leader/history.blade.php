   ...
   <div class="row">
      <div class="col-md-3">
         <div class="nav flex-column justify-content-start nav-pills nav-primary" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <a class="nav-link  text-left pl-3" id="v-pills-basic-tab" href="{{ route('sp.leader.approval') }}" aria-controls="v-pills-basic" aria-selected="true">
               <i class="fas fa-address-book mr-1"></i>
               Surat Peringatan & Teguran
            </a>
            <a class="nav-link  active text-left pl-3" id="v-pills-contract-tab" href="{{ route('sp.leader.history') }}" aria-controls="v-pills-contract" aria-selected="false">
